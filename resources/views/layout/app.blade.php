...
<head>
    ...
    <title>Etrain</title>
    <link rel="icon" href="{{asset('assetshome')}}/img/favicon.png">
    <!-- Bootstrap CSS -->
    ...
    <!-- flaticon CSS -->
    <link rel="stylesheet" href="{{asset('assetshome')}}/css/flaticon.css">
    <!-- font awesome CSS -->
    <link rel="stylesheet" href="{{asset('assetshome')}}/css/magnific-popup.css">
    <!-- swiper CSS -->
    <link rel="stylesheet" href="{{asset('assetshome')}}/css/slick.css">
    <!-- style CSS -->
